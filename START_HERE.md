...
이 완성본에는 솔솔계산소 홈, 낮·밤 테마, 12지신 대표 그림, **계산기마다 다른 캐릭터 장면 12개**, 서로 다른 주소를 가진 계산기 12개, 카테고리 4개, 소개·문의·개인정보·약관·404, 사이트맵·검색 노출 기본 설정, 자동검사와 Cloudflare Workers 설정이 들어 있습니다.
...
이어서 `테마 검사 통과`까지 보이면 홈 낮·밤 그림과 계산기 장면 12개도 모두 연결된 것입니다.
